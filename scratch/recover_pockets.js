...
async function search() {
    ...
    if (latestPockets) {
        fs.writeFileSync(path.join(outputDir, 'latest_pockets_edit.json'), JSON.stringify(latestPockets, null, 2));
        console.log('Found latest Pockets.tsx edit at ' + latestPockets.date);
    } else {
