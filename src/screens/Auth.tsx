...
// El path fuente es 384x512 (más alto que ancho) -- si se fuerza a un
// cuadrado wxh iguales, SVG lo encoge para que quepa en esa altura y
// termina más angosto que el ícono de Google (que sí es 1:1). Se respeta
// la proporción real: mismo ancho que Google, un poco más alto.
